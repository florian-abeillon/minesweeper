...
def deepInvestigation(connected_edges):
    ...
    has_moved_on = False
    # min_max_hidden_edge = hidden_edges[0]
    for hidden_edge in hidden_edges:
        if hidden_edge[1] == 0:
        ...
        # elif hidden_edge[1] < min_max_hidden_edge[1]:
        #     min_max_hidden_edge = hidden_edge
...
def probabilisticClick():
    ...
    min_max_proba_global = 1
    min_max_hidden_neighbor = min_edges[0]
    for min_edge in min_edges:
        ...
        min_hidden_neighbor = min_hidden_neighbors[0]
        min_max_proba = 1
        for hidden_neighbor in min_hidden_neighbors:
            ...
            if max_proba < min_max_proba:
                ...
                min_hidden_neighbor = hidden_neighbor

        if min_max_proba < min_max_proba_global:
            min_max_proba_global = min_max_proba
            min_max_hidden_neighbor = min_hidden_neighbor

    if Verbose:
        print("Minimal proba:", min_max_proba)
    clickOn(min_max_hidden_neighbor[0], min_max_hidden_neighbor[1])
